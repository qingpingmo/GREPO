...
def parse_args():
    ...
    parser.add_argument('--joint_training', action='store_true', help='Enable joint training mode to train on multiple repos')
    parser.add_argument('--repos', type=str, nargs='+', default=[], help='List of multiple repo names used in joint training mode, for example: --repos astropy scipy pandas')
